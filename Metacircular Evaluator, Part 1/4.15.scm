...
;; procedure halts? that correctly determines whether p halts on a for any procedure 
;; p and object a. Use the following reasoning: If you had such a procedure halts?, 
...
; If try evaluates itself and it halts, it will enter the if-branch where it will run 
; forever. And if it does not halt, it will enter the branch where it halts. This is a
; contradiction and therefore such a procedure cannot exist (in this model of 
; computation).
