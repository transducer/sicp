...
; of x onto y. The procedure append! is similar to append, but 
; it is a mutator rather than a constructor. It appends the 
; lists by splicing them together, modifying the final pair of x
; so that its cdr is now y. (It is an error to call append! with 
; an empty x.)
