...
; source: https://mitpress.mit.edu/sicp/code/ch4-analyzingmceval.scm
...
(define (execute-application proc args)
  (cond ((primitive-procedure? proc)
         (metacircular-apply-primitive-procedure proc args))
...
(define (metacircular-apply procedure arguments)
  (cond ((primitive-procedure? procedure)
         (metacircular-apply-primitive-procedure procedure arguments))
...
;[moved to start of file] (define metacircular-apply-in-underlying-scheme metacircular-apply)
